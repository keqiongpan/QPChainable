...
Pod::Spec.new do |s|
  s.name             = 'QPChainable'
  s.version          = '0.1.0'
  s.summary          = 'Provides an easy way to construct chained expressions for Cbjective-C.'
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.description      = 'Provides an easy way to construct chained expressions for Cbjective-C.'

  s.homepage         = 'https://github.com/keqiongpan/QPChainable'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'keqiongpan' => 'keqiongpan@163.com' }
